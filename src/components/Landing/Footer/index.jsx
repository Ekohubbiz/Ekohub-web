        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            ...
            <ul className="text-white dark:text-gray-400">
              <li className="mb-4">
                <Link to={paths.CONTACT_US} className="hover:underline">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to={paths.TOC} className="hover:underline">
                  Terms &amp; Conditions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="text-white dark:text-gray-400">
              <li className="mb-4">
                <Link to={paths.POLICY} className="hover:underline">
                  Privacy Policy
                </Link>
              </li>
            </ul>
